...
import com.example.esisaandroid.databinding.ActivityBeyazesyaBireyselBinding
...
class BeyazesyaBireyselActivity : AppCompatActivity() {
    private lateinit var binding:ActivityBeyazesyaBireyselBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityBeyazesyaBireyselBinding.inflate(layoutInflater)
