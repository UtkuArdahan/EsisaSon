...
import com.example.esisaandroid.databinding.ActivityKurumsalKozmetikBinding
...
class KurumsalKozmetikActivity : AppCompatActivity() {
    private lateinit var binding:ActivityKurumsalKozmetikBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityKurumsalKozmetikBinding.inflate(layoutInflater)
