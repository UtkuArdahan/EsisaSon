...
import com.example.esisaandroid.databinding.ActivityPumaBinding

class PumaActivity : AppCompatActivity() {
    private lateinit var binding:ActivityPumaBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityPumaBinding.inflate(layoutInflater)
