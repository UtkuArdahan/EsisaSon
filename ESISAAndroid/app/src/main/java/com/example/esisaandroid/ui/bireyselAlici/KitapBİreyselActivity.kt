...
import com.example.esisaandroid.databinding.ActivityKitapBireyselBinding
...
class KitapBİreyselActivity : AppCompatActivity() {
    private lateinit var binding:ActivityKitapBireyselBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityKitapBireyselBinding.inflate(layoutInflater)
