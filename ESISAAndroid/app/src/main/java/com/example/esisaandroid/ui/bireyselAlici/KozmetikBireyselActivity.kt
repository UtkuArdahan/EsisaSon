...
import com.example.esisaandroid.databinding.ActivityKozmetikBireyselBinding
...
class KozmetikBireyselActivity : AppCompatActivity() {
    private lateinit var binding:ActivityKozmetikBireyselBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityKozmetikBireyselBinding.inflate(layoutInflater)
