...
import com.example.esisaandroid.databinding.FragmentKurumsalAliciAnasayfaBinding
 ...
 * Use the [KurumsalAliciAnasayfaFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class KurumsalAliciAnasayfaFragment : Fragment() {
    private var _binding: FragmentKurumsalAliciAnasayfaBinding? = null
...
// onDestroyView.
    ...
    override fun onCreateView(
        ...
        _binding = FragmentKurumsalAliciAnasayfaBinding.inflate(inflater, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment KurumsalAliciAnasayfaFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            KurumsalAliciAnasayfaFragment().apply {
