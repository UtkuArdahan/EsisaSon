...
import com.example.esisaandroid.databinding.ActivityCkBinding

class CkActivity : AppCompatActivity() {
    private lateinit var binding: ActivityCkBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityCkBinding.inflate(layoutInflater)
