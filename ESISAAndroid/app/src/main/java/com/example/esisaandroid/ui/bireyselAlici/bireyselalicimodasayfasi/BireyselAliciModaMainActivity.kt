package com.example.esisaandroid.ui.bireyselAlici.bireyselalicimodasayfasi
...
import com.example.esisaandroid.databinding.ActivityBireyselAliciModaMainBinding
...
class BireyselAliciModaMainActivity : AppCompatActivity() {
    private lateinit var binding:ActivityBireyselAliciModaMainBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityBireyselAliciModaMainBinding.inflate(layoutInflater)
