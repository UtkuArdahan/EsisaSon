package com.example.esisaandroid.ui.kurumsalAlici.kurumsalalicimoda
...
import com.example.esisaandroid.databinding.ActivityKurumsalAliciModaBinding
...
class KurumsalAliciModaActivity : AppCompatActivity() {
    private lateinit var binding:ActivityKurumsalAliciModaBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityKurumsalAliciModaBinding.inflate(layoutInflater)
