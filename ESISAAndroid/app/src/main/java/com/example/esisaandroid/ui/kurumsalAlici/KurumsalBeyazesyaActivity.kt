...
import com.example.esisaandroid.databinding.ActivityKurumsalBeyazesyaBinding
...
class KurumsalBeyazesyaActivity : AppCompatActivity() {
    private lateinit var binding:ActivityKurumsalBeyazesyaBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityKurumsalBeyazesyaBinding.inflate(layoutInflater)
