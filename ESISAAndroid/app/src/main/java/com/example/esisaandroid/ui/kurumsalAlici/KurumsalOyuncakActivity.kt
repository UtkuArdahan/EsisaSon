...
import com.example.esisaandroid.databinding.ActivityKurumsalOyuncakBinding
...
class KurumsalOyuncakActivity : AppCompatActivity() {
    private lateinit var binding:ActivityKurumsalOyuncakBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityKurumsalOyuncakBinding.inflate(layoutInflater)
