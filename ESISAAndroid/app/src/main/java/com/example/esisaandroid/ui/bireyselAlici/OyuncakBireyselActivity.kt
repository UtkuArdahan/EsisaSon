...
class OyuncakBireyselActivity : AppCompatActivity() {
    private lateinit var binding:ActivityOyuncakBireyselBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding=ActivityOyuncakBireyselBinding.inflate(layoutInflater)
