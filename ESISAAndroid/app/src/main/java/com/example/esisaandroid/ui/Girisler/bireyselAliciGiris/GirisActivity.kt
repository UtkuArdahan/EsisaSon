...
import com.example.esisaandroid.ui.Girisler.bireyselAliciGiris.PsifirlamaActivity
        ...
        binding.saticigirisbuton.setOnClickListener {
            ...
            auth.signInWithEmailAndPassword(saticiemail, saticiparola)
                .addOnCompleteListener(this) {
                    if (it.isSuccessful) {
                        val saticiintent =
                            Intent(applicationContext, SaticiAnasayfaActivity::class.java)
        ...
        binding.kurumsalgirisbuton.setOnClickListener {
            ...
            auth.signInWithEmailAndPassword(kurumsalemail, kurumsalparola)
                .addOnCompleteListener(this) {
                    if (it.isSuccessful) {
                        val kurumsalintent =
                            Intent(applicationContext, KurumsalAliciAnasayfaActivity::class.java)
...
//bireysel giriş butonuna tıklandığında yapılacaklar
        binding.bireyselgirisbuton.setOnClickListener {
            ...
            auth.signInWithEmailAndPassword(email, parola)
                .addOnCompleteListener(this) {
                    if (it.isSuccessful) {
                        val intent =
                            Intent(applicationContext, BireyselAliciAnasayfaActivity::class.java)
        ...
        binding.girisparolaunuttum.setOnClickListener {
            intent = Intent(applicationContext, PsifirlamaActivity::class.java)
            startActivity(intent)
            finish()
        }
