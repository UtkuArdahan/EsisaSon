package com.example.esisaandroid.ui.kurumsalAlici.kurumsalaliciayakkabi
...
import com.example.esisaandroid.databinding.ActivityKurumsalAliciAyakkabiBinding
...
class KurumsalAliciAyakkabiActivity : AppCompatActivity() {
    private lateinit var binding:ActivityKurumsalAliciAyakkabiBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivityKurumsalAliciAyakkabiBinding.inflate(layoutInflater)
